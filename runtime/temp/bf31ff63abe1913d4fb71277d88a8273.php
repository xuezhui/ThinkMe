<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:62:"/home/www/thinkadmin/application/install/view/index/step3.html";i:1480577121;}*/ ?>

<div class="panel panel-default">
    <div class="panel-heading"><?php echo config('PRODUCT_NAME'); ?> 参数设置</div>
    <div class="panel-body" style="font-size: 14px">
        <form role="form" id="form-setup" action="<?php echo url('step2'); ?>" method="post" >
            ...
            <a type="button" href="<?php echo url('index'); ?>" class="btn btn-default btn-block">上一步</a>
        </form>
    </div>
</div>
